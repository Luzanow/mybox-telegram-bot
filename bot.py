...
async def rent_location(message: types.Message):
    ...
    locations = [
        "📍 Лугова 9", "📍 Плодова 1", "📍 Дегтярівська 21", "📍 Сім'ї Сосніних 3",
        "📍 Лобановського 119", "📍 Сортувальна 5", "📍 Пухівська 4А",
        "📍 Новокостянтинівська 18", "📍 Бальзака 85А", "📍 Будіндустрії 5",
        "📍 Бориспільська 9", "📍 Віскозна 1", "📍 Промислова 4"
    ]
